...
final class DatePolicyTest extends TestCase {
 ...
 public function testYesterdayLockedAtNine():void{$state=$this->policy('2026-08-02 09:00:00')->state('2026-08-01');$this->assertFalse($state['editable']);$this->assertSame('locked',$state['state']);}
