...
final class BudgetValidatorTest extends TestCase {
 ...
 public function testAcceptsOneAndTwoDecimalPlaces():void{[$data,$errors]=BudgetValidator::validate(['dailyBudget'=>'3.1','monthlyBudget'=>'100.50','effectiveFrom'=>'2026-09-03','periodDays'=>30]);$this->assertSame([],$errors);$this->assertSame(310,$data['dailyBudgetCentimes']);$this->assertSame(10050,$data['monthlyBudgetCentimes']);}
