...
export function App() {
  const [session,setSession]=useState({loading:true,user:null}),[month,setMonth]=useState('2026-08');
  ...
  </main><footer><span>DAILY DH · PRIVATE LEDGER</span><span>Africa/Casablanca time · Authenticated & securely calculated</span></footer>
